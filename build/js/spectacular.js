...
(function() {
  var PROGRESS_CHAR_MAP, PROGRESS_COLOR_MAP, addClass, cache, currentWindowOnload, defaults, exports, fixNodeHeight, hasClass, isCommonJS, k, loaders, nextTick, removeClass, spectacular, toggleClass, utils, v, wrapNode,
    __slice = [].slice,
  ...
  spectacular.matcher = function(name, block) {
    var match, matcher, o, takes, timeout;
  ...
  spectacular.BrowserReporter = (function() {
    ...
    function BrowserReporter(options) {
      var body, buttons, controls, doc, html, previousOnScroll,
        _this = this;
      this.options = options;
      this.onResult = __bind(this.onResult, this);
      this.onEnd = __bind(this.onEnd, this);
      ...
      window.onscroll = function() {
        var reporterOffset, top, topMax, topMin;
        if (previousOnScroll != null) {
          previousOnScroll();
        }
        reporterOffset = _this.reporter.offsetTop;
        topMin = _this.examplesContainer.offsetTop;
        topMax = topMin + _this.examplesContainer.clientHeight - controls.clientHeight;
        top = (doc && doc.scrollTop || body && body.scrollTop || 0) - reporterOffset;
        top = Math.min(topMax, Math.max(topMin, top + 100));
        return controls.style.top = "" + top + "px";
      };
    }
