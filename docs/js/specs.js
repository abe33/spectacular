...
(function() {
  var ClassWithCollection, Dummy, GlobalizableClass, _ref,
    __slice = [].slice;
  ...
  runningSpecs('missing dependency').shouldStopWith(/unmet dependency foo/, function() {
  ...
  runningSpecs('cascading failing examples').shouldFailWith(/0 success, 1 assertion, 1 failure, (.*), 1 skipped/, function() {
    return describe('parent group', function() {
      it(function() {
        return true.should(be(false));
      });
  ...
  describe(after, function() {
    ...
    the(function() {
      return afterCalled.should(be(true));
    });
