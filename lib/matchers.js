  ...
  return {
    assert: function(actual, notText) {
      ...
      if (this["arguments"] != null) {
        msg += " with arguments " + this["arguments"];
      }
  ...
  assert: function(actual, notText) {
    ...
    if (typeof (actual != null ? actual.spied : void 0) === 'function') {
      if (this["arguments"] != null) {
        ...
        this.message = "Expected " + actual.spied + notText + " to have been called with " + this["arguments"] + " but was called with " + actual.argsForCall;
