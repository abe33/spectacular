...
var ConsoleReporter, Q, fs, glob, globPath, globPaths, loadHelpers, loadMatchers, loadSpecs, loadSpectacular, m, path, requireIntoGlobal, utils, vm, walk;
...
ConsoleReporter = require('./console_reporter').ConsoleReporter;
...
loadSpectacular = function(options) {
  return Q.fcall(function() {
    ...
    return spectacular.env = new spectacular.Environment(ConsoleReporter, options);
  }).then(function() {
