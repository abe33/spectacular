...
var CliMethods, Q, colorize, exists, existsSync, fs, getReporter, glob, globPath, globPaths, handleEmitter, jsdom, loadDOM, loadRequire, loadSpecs, loadSpectacular, m, path, requireFile, sourceMap, util, vm, walk;
...
loadRequire = function(path, options) {
  var defer;
  defer = Q.defer();
...
CliMethods = function(options) {
  ...
  options.valueOutput = function(value) {
    return colorize("" + value, 'bold', spectacular.env.options);
  };
  ...
  return loadSpectacular(options).then(loadDOM).then(function(window) {
    ...
    return Q.all((function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        p = _ref[_i];
        _results.push(loadRequire(p, options));
      }
      return _results;
    })());
  }).then(function() {
