...
exports.ConsoleReporter = (function() {
  function ConsoleReporter(root, options, env) {
    this.root = root;
    this.options = options;
    this.env = env;
  ...
  ConsoleReporter.prototype.registerResult = function(example) {
  ...
  ConsoleReporter.prototype.printResults = function(lstart, lend, sstart, send) {
