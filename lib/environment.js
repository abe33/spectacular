...
spectacular.Environment = (function() {
  function Environment(Runner, options) {
    this.Runner = Runner;
  ...
  Environment.prototype.run = function() {
    this.load();
    return new this.Runner(this.rootExampleGroup, this.options, this).run();
  };
  ...
  Environment.prototype.load = function() {
    ...
    Object.defineProperty(Object.prototype, 'should', {
      ...
      value: function(matcher) {
        ...
        return env.currentExample.result.expectations.push(new spectacular.Expectation(env.currentExample, this, matcher, false));
      }
    });
    Object.defineProperty(Object.prototype, 'shouldnt', {
      ...
      value: function(matcher) {
        env.notOutsideIt('should');
        return env.currentExample.result.expectations.push(new spectacular.Expectation(env.currentExample, this, matcher, true));
      }
    });
    return 'it xit describe xdescribe context xcontext\
      ...
      skip should shouldnt dependsOn'.split(/\s+/g).forEach(function(k) {
      return global[k] = function() {
  ...
  Environment.prototype.clone = function() {
    ...
    return new spectacular.Environment(this.Runner, optionsCopy);
  };
  ...
  Environment.prototype.itsInstance = function(block) {
    return this.notInsideIt('itsInstance');
  };
  ...
  Environment.prototype.describe = function(subject, options, block) {
    ...
    return this.currentExampleGroup = oldGroup;
  };

  Environment.prototype.xdescribe = function(subject, block) {
    return this.notInsideIt('xdescribe');
  };

  Environment.prototype.context = Environment.prototype.describe;

  Environment.prototype.xcontext = Environment.prototype.xdescribe;
  ...
  Environment.prototype.should = function(matcher, neg) {
    ...
    return this.currentExample.result.expectations.push(new spectacular.Expectation(this.currentExample, this.currentExample.subject, matcher, neg));
  };
