...
Runner = (function() {
  ...
  Runner.prototype.register = function(example) {
    var dep, s, spec, _i, _len, _ref, _results;
    ...
    if (example.dependencies.length > 0) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        dep = _ref[_i];
        spec = this.root.identifiedExamplesMap[dep];
        if (spec != null) {
          if (spec.children != null) {
            _results.push((function() {
              var _j, _len1, _ref1, _results1;

              _ref1 = spec.allExamples;
              _results1 = [];
              for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
                s = _ref1[_j];
                _results1.push(this.register(s));
              }
              return _results1;
            }).call(this));
          } else {
            _results.push(this.register(spec));
          }
        } else {
