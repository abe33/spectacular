...
exports.StackFormatter = (function() {
  ...
  StackFormatter.prototype.print = function() {
    ...
    stackString = this.error.stack.replace(/^[^ ]{4}.*\n/, '');
...
exports.ResultsFormatter = (function() {
  function ResultsFormatter(root, options) {
    this.root = root;
    this.options = options;
    this.results = [];
    this.examples = [];
  ...
  ResultsFormatter.prototype.printFailure = function(message) {
    var badge;
  ...
  ResultsFormatter.prototype.printError = function(message) {
    var badge;
