...
exports.ResultsFormatter = (function() {
  ...
  ResultsFormatter.prototype.buildResults = function(lstart, lend, sstart, send) {
    ...
    if (this.options.profile) {
      res += this.formatProfile(sstart, send);
    }
  ...
  ResultsFormatter.prototype.formatExampleFailure = function(example) {
    ...
    res += this.formatError(example.reason);
    return res += '\n';
  };
  ...
  ResultsFormatter.prototype.formatExampleError = function(example) {
    ...
    return res += this.formatError(example.reason);
  };
  ...
  ResultsFormatter.prototype.formatProfile = function(specsStartedAt, specsEndedAt) {
    var example, rate, res, sortedExamples, topSlowest, totalDuration, _i, _len;
    ...
    for (_i = 0, _len = sortedExamples.length; _i < _len; _i++) {
      ...
      res += "    " + ("" + (Math.floor(example.duration) / 1000) + " seconds").red + " " + example.description + "\n";
    }
    return "" + res + "\n";
  };
