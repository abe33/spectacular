...
var Q, ResultsFormatter, fs, glob, globPath, globPaths, loadHelpers, loadMatchers, loadSpecs, loadSpectacular, m, path, requireIntoGlobal, vm, walk;
...
loadSpectacular = function(options) {
  return Q.fcall(function() {
    ['factories', 'extensions', 'mixins', 'promises', 'examples', 'runner', 'environment'].forEach(function(file) {
      var filename, src;
    ...
    return spectacular.env = new spectacular.Environment(ResultsFormatter, options);
  }).then(function() {
