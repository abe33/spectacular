...
var BADGE_MAP, CHAR_MAP, COLOR_MAP, Plurals, addClass, ancestors, buildHTML, currentWindowOnload, defaults, displayErrors, errors, escapeHTML, fixNodeHeight, hasClass, hasErrors, icon, k, removeClass, selfAndAncestors, stripHTML, tag, toggleClass, utils, v, viewerSize, wrapNode, _ref,
...
spectacular.URLParameters = (function() {
  function URLParameters(parameters) {
    ...
    tuples.forEach(function(_arg) {
      ...
      keys = _this.parseKey(key);
      return _this.consumeKeys(_this, keys, value);
    });
  }
