...
spectacular.BrowserReporter = (function() {
  function BrowserReporter() {
    ...
    this.examples = this.reporter.find('#examples');
  ...
  BrowserReporter.prototype.registerResult = function(example) {
    ...
    if (example.result.expectations.length > 0) {
      return this.examples.append("<article class=\"example " + example.result.state + "\" id=\"example_" + this.examples.length + "\">\n  <header>\n    <h4>" + example.description + "</h4>\n  </header>\n  <div class=\"expectations\">\n    " + ((function() {
