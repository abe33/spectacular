...
spectacular.widgets.ExamplesList = (function() {
  ...
  ExamplesList.prototype.selectExample = function(example, node) {
    var previous;
    previous = this.list.querySelector('.active');
    if (previous != null) {
      removeClass(previous, 'active');
    }
    addClass(node, 'active');
    this.viewer.displayCard(example);
    return this.reporter.openDetails();
  };
  ...
  ExamplesList.prototype.getExample = function(example) {
    ...
    node.onclick = function() {
      return _this.selectExample(_this.examples[node.attributes.id.value], node);
    };
    return node;
  };
...
spectacular.BrowserReporter = (function() {
  ...
  BrowserReporter.prototype.errorOccured = function() {
