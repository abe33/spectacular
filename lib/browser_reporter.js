...
spectacular.widgets.ExamplesList = (function() {
  ...
  ExamplesList.prototype.init = function(runner) {
    var _this = this;
    this.runner = runner;
    this.examples = [];
  ...
  ExamplesList.prototype.onResult = function(event) {
    return this.buildExample(event.target);
  };
  ...
  ExamplesList.prototype.buildExample = function(example) {
    ...
    node.appendChild(tag('article', example.fullDescription, {
      "class": 'example',
  ...
  ExamplesList.prototype.getParent = function(example) {
    var a, ancestor, content, elders, id, n, node, parent, reversed, _i, _j, _len, _len1;
...
window.onload = function() {
  ...
  reporter = new spectacular.BrowserReporter(spectacular.env.runner, [new spectacular.widgets.RunnerProgress, new spectacular.widgets.ExamplesList]);
  reporter.init();
