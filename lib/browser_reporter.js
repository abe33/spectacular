...
spectacular.BrowserReporter = (function() {
  ...
  BrowserReporter.prototype.onResult = function(event) {
    ...
    this.counters.innerHTML = this.formatCounters() + this.getSeed();
  ...
  BrowserReporter.prototype.getSeed = function() {
    if (this.options.random && (this.options.seed != null)) {
      return this.formatSeed(this.options.seed);
    } else {
      return '';
    }
  };

  BrowserReporter.prototype.formatSeed = function(seed) {
    return "<span class='blue'><span>seed</span> " + seed + "</span>";
  };
