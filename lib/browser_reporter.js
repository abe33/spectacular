...
var BADGE_MAP, CHAR_MAP, COLOR_MAP, Plurals, a, addClass, ancestors, buildHTML, currentWindowOnload, defaults, displayErrors, errors, escapeHTML, fixNodeHeight, hasClass, hasErrors, icon, k, params, removeClass, selfAndAncestors, stripHTML, tag, toggleClass, utils, v, viewerSize, wrapNode, _ref,
...
params = new spectacular.URLParameters(a.search.slice(1));
