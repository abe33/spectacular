...
spectacular.Environment = (function() {
  ...
  Environment.prototype.itsReturn = function(options, block) {
    var msg, parentSubjectBlock, _ref,
      _this = this;
    ...
    if (options["with"] != null) {
      msg += " with " + (utils.inspect(options["with"]));
    }
    if (options.inContext != null) {
      msg += " in context " + (utils.inspect(options.inContext));
    }
    return this.context(msg, function() {
