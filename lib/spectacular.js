...
var exports, f, isCommonJS, nextTick, spectacular,
  __slice = [].slice,
...
spectacular.getGlobal = function() {
  return f.call(null);
};
...
spectacular.factories.build = function(ctor, args) {
  var argumentsSignature, comma, n;
...
spectacular.Environment = (function() {
  Environment.getGlobal = function() {
  ...
  function Environment(Formatter, options) {
    this.Formatter = Formatter;
    this.options = options;
    ...
    this.runner = new spectacular.Runner(this.rootExampleGroup, this.options, this, this.formatter);
  }
  ...
  Environment.prototype.load = function() {
    ...
    return this.exposedMethods.split(/\s+/g).forEach(function(k) {
      ...
      fn._name = k;
      return Environment.getGlobal()[k] = fn;
    });
  };
  ...
  Environment.prototype.clone = function() {
    ...
    return new spectacular.Environment(this.Formatter, optionsCopy);
  };
