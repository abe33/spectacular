...
spectacular.Globalizable = (function() {
  ...
  Globalizable.prototype.globalize = function() {
    ...
    this.constructor.EXPOSED_PROPERTIES.forEach(function(k) {
      var self, value;
...
spectacular.Environment = (function() {
  ...
  Object.defineProperty(Environment, 'EXPOSED_PROPERTIES', {
    get: function() {
      return 'it xit describe xdescribe context xcontext\
  ...
  function Environment(options) {
    ...
    this.globalize = __bind(this.globalize, this);
    this.run = __bind(this.run, this);
