...
spectacular.matcher('equal', function() {
  ...
  match(function(actual) {
    return utils.compare(actual, this.value, this);
  });
  failureMessageForShould(function() {
    return "Expected " + (utils.inspect(this.actual)) + " to be equal to " + (utils.inspect(this.value));
  });
  return failureMessageForShouldnt(function() {
    return "Expected " + (utils.inspect(this.actual)) + " to be different than " + (utils.inspect(this.value));
  });
});
...
spectacular.matcher('haveBeenCalled', function() {
  ...
  failureMessageForShould(function() {
    if (typeof (typeof actual !== "undefined" && actual !== null ? actual.spied : void 0) === 'function') {
      if (this["arguments"] != null) {
