...
spectacular.Environment = (function() {
  ...
  Environment.prototype.createSpy = function(name, obj, method) {
    var context, oldMethod, spy;
    context = this.currentExample.context;
    oldMethod = obj != null ? obj[method] : void 0;
    spy = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
  ...
  Environment.prototype.spyOn = function(obj, method) {
    ...
    spy = this.createSpy(method, obj, method);
...
spectacular.matcher('haveBeenCalled', function() {
  ...
  match(function(actual, notText) {
    var _this = this;
    if ((actual != null ? actual.argsForCall : void 0) != null) {
      if (this["arguments"] != null) {
  ...
  failureMessageForShould(function() {
    var _ref;
    if (((_ref = this.actual) != null ? _ref.argsForCall : void 0) != null) {
      if (this["arguments"] != null) {
        return "Expected " + (this.formatValue(this.actual)) + " to " + this.description + " but was called with " + (this.formatValue(this.actual.argsForCall));
      } else {
        return "Expected " + (this.formatValue(this.actual)) + " to have been called";
      }
    } else {
  ...
  return failureMessageForShouldnt(function() {
    ...
    if (((_ref = this.actual) != null ? _ref.argsForCall : void 0) != null) {
      if (this["arguments"] != null) {
        return "Expected " + (this.formatValue(this.actual)) + " not to " + this.description + " but was called with " + this.actual.argsForCall;
      } else {
        return "Expected " + (this.formatValue(this.actual)) + " not to have been called";
      }
    } else {
      return this.message = "Expected a spy but it was " + (this.formatValue(this.actual));
    }
    ...
    if (this.error.stack != null) {
      ...
      if (this.options.showSource) {
        ...
        if (file != null) {
          ...
          stackFormatter.format().then(function(result) {
            res += result;
            return promise.resolve(res);
          }).fail(function(reason) {
            console.log(reason);
