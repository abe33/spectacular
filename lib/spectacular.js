...
spectacular.Example = (function() {
  Example.include(spectacular.HasAncestors, spectacular.Describable, spectacular.FollowUpProperty('subjectBlock'), spectacular.MergeUpProperty('beforeHooks'), spectacular.MergeUpProperty('afterHooks'), spectacular.MergeUpProperty('dependencies'));
