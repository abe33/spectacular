...
spectacular.deprecated = function(message) {
  var caller, deprecatedMethodCallerFile, deprecatedMethodCallerName, deprecatedMethodFile, deprecatedMethodName, e, parseLine, s, _ref, _ref1;
  parseLine = function(line) {
    var f, m, o, _ref, _ref1, _ref2;
    if (line.indexOf('@') > 0) {
      _ref = /<\/([^@]+)@(.)+$/.exec(line), m = _ref[0], o = _ref[1], f = _ref[2];
    } else {
      if (line.indexOf('(') > 0) {
        _ref1 = /at\s+([^\s]+)\s*\(([^\)])+/.exec(line), m = _ref1[0], o = _ref1[1], f = _ref1[2];
      } else {
        _ref2 = /at\s+([^\s]+)/.exec(line), m = _ref2[0], f = _ref2[1];
      }
    }
    return [o, f];
  };
  e = new Error();
  s = e.stack.split('\n');
  _ref = parseLine(s[2]), deprecatedMethodName = _ref[0], deprecatedMethodFile = _ref[1];
  _ref1 = parseLine(s[3]), deprecatedMethodCallerName = _ref1[0], deprecatedMethodCallerFile = _ref1[1];
...
spectacular.factories.Trait = (function() {
  ...
  Trait.prototype.globalizable = 'set createWith build'.split(/\s+/g);
...
spectacular.factories.Factory = (function(_super) {
  ...
  Factory.prototype.globalizable = 'set trait createWith build include'.split(/\s+/g);
