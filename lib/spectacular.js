...
var currentExample, currentExampleGroup, notInsideIt, notOutsideIt, rootExampleGroup, spectacular,
  __slice = [].slice,
...
spectacular.CollectUpProperty = function(property, collect) {
  var ConcreteCollectUpProperty;

  return ConcreteCollectUpProperty = (function() {
    function ConcreteCollectUpProperty() {}

    ConcreteCollectUpProperty.included = function(ctor) {
      return ctor.getter(property, function() {
        var a;
    ...
    return ConcreteCollectUpProperty;
...
spectacular.Example = (function() {
  Example.include(spectacular.HasAncestors, spectacular.Describable, spectacular.FollowUpProperty('subjectBlock'), spectacular.MergeUpProperty('beforeHooks'), spectacular.MergeUpProperty('afterHooks'), spectacular.CollectUpProperty('dependencies', function(e) {
    var _ref;

    return ((_ref = e.options) != null ? _ref.dependencies : void 0) || [];
  }));
  ...
  Example.getter('subject', function() {
    ...
    return this.__subject || (this.__subject = (_ref = this.subjectBlock) != null ? _ref.call(this) : void 0);
  });
...
spectacular.dependsOn = function(spec) {
  ...
  (_base = currentExampleGroup.options).dependencies || (_base.dependencies = []);
  return currentExampleGroup.options.dependencies.push(spec);
};
