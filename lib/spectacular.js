...
spectacular.dom.DOMParser = (function() {
  DOMParser.include(spectacular.HasCollection('expressions', 'expression'));

  function DOMParser(source) {
    this.source = source;
    this.expressions = [];
    this.parse();
  }

  DOMParser.prototype.parse = function() {
    ...
    return this.source.split('\n').forEach(function(line, i) {
      var expr, exprInst, indent, invalidIndent;

      invalidIndent = function() {
        throw new Error("invalid indent on line " + (i + 1) + " of '" + this.source + "'");
      };
  ...
  DOMParser.prototype.getIndent = function(line) {
    var re;
  ...
  DOMParser.prototype.match = function(el) {
    return this.expressions.every(function(e) {
      return e.match(el);
    });
  };

  DOMParser.prototype.contained = function(el) {
    return this.expressions.every(function(e) {
      return e.contained(el);
    });
  };
