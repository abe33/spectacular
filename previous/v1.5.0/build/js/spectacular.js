...
(function() {
  var BADGE_MAP, CHAR_MAP, COLOR_MAP, LINE_RE, Plurals, URI_RE, a, addClass, ancestors, buildHTML, currentWindowOnload, defaults, displayErrors, errors, escapeHTML, exports, fixNodeHeight, hasClass, hasErrors, icon, isCommonJS, k, params, removeClass, selfAndAncestors, spectacular, stripHTML, tag, toggleClass, utils, v, viewerSize, wrapNode, _ref, _ref1,
    __slice = [].slice,
  ...
  spectacular.Example = (function() {
    ...
    Example.prototype.skip = function() {
      var error, specIndex, stack, _ref;
      if ((_ref = this.examplePromise) != null ? _ref.pending : void 0) {
        ...
        return this.examplePromise.reject(error);
      }
    };
  ...
  spectacular.RunnerResults = (function() {
    function RunnerResults(runner) {
      var _ref;
      this.runner = runner;
      this.errors = [];
      this.failures = [];
      ...
      this.results = [];
      this.examples = [];
      _ref = this.runner, this.loadStartedAt = _ref.loadStartedAt, this.loadEndedAt = _ref.loadEndedAt;
      this.specsStartedAt = null;
      this.specsEndedAt = null;
    }

    RunnerResults.prototype.hasFailures = function() {
  ...
  spectacular.Runner = (function() {
    ...
    Runner.prototype.run = function() {
      ...
      return promise = spectacular.Promise.unit(results).then(function(results) {
        results.specsStartedAt = new Date();
        return results;
      }).then(this.registerSpecs).then(this.executeSpecs).then(function(results) {
        results.specsEndedAt = new Date();
        return results;
      }).then(this.notifyEnd).then(function(results) {
    ...
    Runner.prototype.registerSpecs = function(results) {
      var example, set, _i, _len;
      ...
      for (_i = 0, _len = set.length; _i < _len; _i++) {
        example = set[_i];
        this.register(example, this.root.hasExclusiveExamples());
      }
      this.dispatch(new spectacular.Event('start', this));
      return results;
    };
    ...
    Runner.prototype.executeSpecs = function(results) {
      var promise;
      promise = new spectacular.Promise;
      this.nextExample(promise, results);
      return promise;
    };

    Runner.prototype.nextExample = function(defer, results) {
      var _this = this;
      return spectacular.nextTick(function() {
        ...
        if (_this.stack.length === 0) {
          ...
          return nextExample.run().then(function() {
            _this.handleResult(nextExample, results);
            return _this.nextExample(defer, results);
          }).fail(function(reason) {
            _this.handleResult(nextExample, results);
            return _this.nextExample(defer, results);
          });
    ...
    Runner.prototype.handleResult = function(example, results) {
      results.results.push(example.result);
      results.examples.push(example);
      switch (example.result.state) {
        case 'pending':
          results.pending.push(example);
          break;
        case 'skipped':
          results.skipped.push(example);
          break;
        case 'errored':
          results.errors.push(example);
          break;
        case 'failure':
          results.failures.push(example);
      }
      this.dispatch(new spectacular.Event('result', example));
      return this.env.currentExample = null;
    };

    Runner.prototype.notifyEnd = function(results) {
      this.dispatch(new spectacular.Event('end', results));
      return results;
    };
  ...
  spectacular.Environment = (function() {
    ...
    Environment.prototype.fail = function() {
      ...
      return this.currentExample.reject(error);
    };
    ...
    Environment.prototype.fixturePath = function(file) {
      return "" + this.options.fixturesRoot + "/" + file;
    };
  ...
  spectacular.matcher = function(name, block) {
    ...
    buildMatcher = function(takes, args) {
      ...
      matcher.formatValue = function(value) {
        var _ref, _ref1;
        return ((_ref = spectacular.env) != null ? (_ref1 = _ref.options) != null ? typeof _ref1.valueOutput === "function" ? _ref1.valueOutput(value) : void 0 : void 0 : void 0) || value;
      };
      for (k in chains) {
        v = chains[k];
  ...
  spectacular.matcher('exist', function() {
    ...
    failureMessageForShould(function() {
      return "Expected " + (this.formatValue(this.actual)) + " to exist";
    });
    return failureMessageForShouldnt(function() {
      return "Expected " + (this.formatValue(this.actual)) + " to be undefined";
    });
  });
  ...
  spectacular.matcher('be', function() {
    ...
    description(function() {
      var desc;
      desc = typeof this.desc === 'string' ? this.desc : this.formatValue(utils.squeeze(utils.inspect(this.value)));
      return "be " + desc;
    });
    failureMessageForShould(function() {
      switch (typeof this.value) {
        case 'string':
          return "Expected " + (this.formatValue(this.actual)) + " to " + this.description + " but was " + (this.formatValue(this.stateValue));
        case 'number':
        case 'boolean':
          return "Expected " + (this.formatValue(this.actual)) + " to " + this.description;
        default:
          return this.message = "Expected " + (this.formatValue(utils.inspect(this.actual))) + " to " + this.description;
      }
    });
    failureMessageForShouldnt(function() {
      switch (typeof this.value) {
        case 'string':
          return "Expected " + (this.formatValue(this.actual)) + " not to " + this.description + " but was " + (this.formatValue(this.stateValue));
        case 'number':
        case 'boolean':
          return "Expected " + (this.formatValue(this.actual)) + " not to " + this.description;
        default:
          return this.message = "Expected " + (this.formatValue(utils.inspect(this.actual))) + " not to " + this.description;
      }
    });
      ...
      switch (typeof this.value) {
        ...
        case 'function':
          if (typeof this.actual === 'function') {
            ...
            return (actual != null ? actual.constructor : void 0) === this.value;
          }
          break;
        default:
          return actual === this.value;
  ...
  spectacular.matcher('have', function() {
    ...
    failureMessageForShould(function() {
      switch (typeof this.actual) {
        case 'string':
          return "Expected string " + (this.formatValue(utils.inspect(this.actual))) + " to " + this.description + " but was " + (this.formatValue(this.actual.length));
        case 'object':
          if (utils.isArray(this.actual)) {
            return "Expected array " + (this.formatValue(utils.inspect(this.actual))) + " to " + this.description + " but was " + (this.formatValue(this.actual.length));
          } else {
            return this.message = "Expected object " + (this.formatValue(utils.inspect(this.actual))) + " to " + this.description;
          }
          break;
        default:
          return this.message = "Expected " + (this.formatValue(utils.inspect(this.actual))) + " to " + this.description + " but it don't belong to a type that can be handled";
      }
    });
    return failureMessageForShouldnt(function() {
      switch (typeof this.actual) {
        case 'string':
          return "Expected string " + (this.formatValue(utils.inspect(this.actual))) + " not to " + this.description + " but was " + (this.formatValue(this.actual.length));
        case 'object':
          if (utils.isArray(this.actual)) {
            return "Expected array " + (this.formatValue(utils.inspect(this.actual))) + " not to " + this.description + " but was " + (this.formatValue(this.actual.length));
          } else {
            return this.message = "Expected object " + (this.formatValue(utils.inspect(this.actual))) + " not to " + this.description;
          }
          break;
        default:
          return this.message = "Expected " + (this.formatValue(utils.inspect(this.actual))) + " not to " + this.description + " but it don't belong to a type that can be handled";
      }
    });
  });

  spectacular.matcher('haveProperty', function() {
    takes('property');
    chain('to', function(matcher) {
      this.matcher = matcher;
    });
    description(function() {
      var desc;
      desc = "have property " + (this.formatValue(this.property));
      if (this.matcher != null) {
        desc += ' to ' + this.matcher.description;
      }
      return desc;
    });
    match(function(actual) {
      if (this.matcher != null) {
        return (actual[this.property] != null) && this.matcher.match(actual[this.property]);
      } else {
        return actual[this.property] != null;
      }
    });
    failureMessageForShould(function() {
      var desc;
      desc = "Expected " + (this.formatValue(utils.inspect(this.actual))) + " to have a property " + (this.formatValue(this.property));
      if (this.matcher != null) {
        desc += ' to ' + this.matcher.description;
      }
      return desc;
    ...
    return failureMessageForShouldnt(function() {
      var desc;
      desc = "Expected " + (this.formatValue(utils.inspect(this.actual))) + " not to have a property " + (this.formatValue(this.property));
      if (this.matcher != null) {
        desc += ' to ' + this.matcher.description;
      }
      return desc;
  ...
  spectacular.matcher('haveProperties', function() {
    var collectHashs, collectStrings;
    collectStrings = function(col) {
      return col.filter(function(el) {
        return typeof el === 'string';
      });
    };
    collectHashs = function(col) {
      return col.filter(function(el) {
    ...
    takes('properties...');
    description(function() {
      var desc, descs, hashProperties, stringProperties,
        _this = this;
      stringProperties = collectStrings(this.properties).map(function(v) {
        return _this.formatValue(v);
      });
      hashProperties = collectHashs(this.properties);
      descs = [];
      descs = descs.concat(stringProperties);
      hashProperties.forEach(function(item) {
        var _results;
        _results = [];
        for (k in item) {
          v = item[k];
          _results.push(descs.push("" + (_this.formatValue(k)) + " to " + v.description));
        }
        return _results;
      });
      desc = "have " + (descs.length > 1 ? 'properties' : 'property') + " ";
    ...
    match(function(actual) {
      ...
      this.properties.forEach(function(key) {
        ...
        if (typeof key === 'object') {
          _results = [];
          for (k in key) {
            _results.push(_this.matchers.push(haveProperty(k).to(key[k])));
          }
          return _results;
        } else {
          return _this.matchers.push(haveProperty(key));
        }
      });
      res = true;
      _ref = this.matchers;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        m = _ref[_i];
        res = m.match(actual) && res;
      }
      return res;
    });
    failureMessageForShould(function() {
      var _ref;
      return (_ref = this.matchers) != null ? _ref.filter(function(m) {
        return !m.success;
      }).map(function(m) {
        return m.messageForShould;
      }).join('\n') : void 0;
    });
    return failureMessageForShouldnt(function() {
      var _ref;
  ...
  spectacular.matcher('haveBeenCalled', function() {
    description(function() {
      ...
      if (this["arguments"] != null) {
        msg += "with " + (this.formatValue(utils.inspect(this["arguments"])));
      }
      return msg;
    });
    chain('with', function() {
    ...
    failureMessageForShould(function() {
      ...
      if (typeof ((_ref = this.actual) != null ? _ref.spied : void 0) === 'function') {
        if (this["arguments"] != null) {
          return "Expected " + (this.formatValue(this.actual.spied)) + " to " + this.description + " but was called with " + (this.formatValue(this.actual.argsForCall));
        } else {
          return "Expected " + (this.formatValue(this.actual.spied)) + " to have been called";
        }
      } else {
        return this.message = "Expected a spy but it was " + (this.formatValue(this.actual));
      }
    });
    return failureMessageForShouldnt(function() {
      var _ref;
      if (typeof ((_ref = this.actual) != null ? _ref.spied : void 0) === 'function') {
        if (this["arguments"] != null) {
          return "Expected " + (this.formatValue(this.actual.spied)) + " not to " + this.description + " but was called with " + this.actual.argsForCall;
        } else {
          return "Expected " + (this.formatValue(this.actual.spied)) + " not to have been called";
        }
      } else {
        return this.message = "Expected a spy but it was " + (this.formatValue(this.actual));
      }
  ...
  spectacular.matcher('equal', function() {
    takes('value');
    description(function() {
      return "be equal to " + (this.formatValue(utils.squeeze(utils.inspect(this.value))));
    });
    match(function(actual) {
      this.diff = {
        diff: ''
      };
      return this.result = utils.compare(actual, this.value, this.diff);
    });
    failureMessageForShould(function() {
      var msg, _ref;
      msg = "Expected " + (this.formatValue(utils.inspect(this.actual))) + " to be equal to " + (this.formatValue(utils.inspect(this.value)));
      if (((_ref = this.diff) != null ? _ref.diff.length : void 0) > 0 && !this.result) {
        msg += "\n\n" + this.diff.diff;
      }
      return msg;
    });
    return failureMessageForShouldnt(function() {
      var msg, _ref;
      msg = "Expected " + (this.formatValue(utils.inspect(this.actual))) + " to be different than " + (this.formatValue(utils.inspect(this.value)));
      if (((_ref = this.diff) != null ? _ref.diff.length : void 0) > 0 && !this.result) {
        msg += "\n\n" + this.diff.diff;
      }
      return msg;
  ...
  spectacular.matcher('beWithin', function() {
    takes('delta');
    description(function() {
      return "be within " + (this.formatValue(utils.squeeze(utils.inspect(this.delta)))) + " of " + (this.formatValue(utils.squeeze(utils.inspect(this.expected))));
    });
    ...
    failureMessageForShould(function() {
      return "Expected " + (this.formatValue(utils.inspect(this.actual))) + " to " + this.description;
    });
    return failureMessageForShouldnt(function() {
      return "Expected " + (this.formatValue(utils.inspect(this.actual))) + " not to " + this.description;
    });
  });
  ...
  spectacular.matcher('match', function() {
    takes('re');
    description(function() {
      return "match " + (this.formatValue(this.re));
    });
    match(function(actual) {
      if ((this.re.match != null) && (this.re.contained != null)) {
        return this.re.match(actual);
      } else if (this.re.test != null) {
        return this.re.test(actual);
      } else {
        return String(actual).indexOf(this.re) !== -1;
      }
    });
    failureMessageForShould(function() {
      if ((this.re.match != null) && (this.re.contained != null)) {
        return "Expected " + (this.formatValue(utils.descOfNode(this.actual))) + " to match " + (this.formatValue(this.re));
      } else {
        return this.message = "Expected " + (this.formatValue(this.actual)) + " to match " + (this.formatValue(this.re));
      }
    });
    return failureMessageForShouldnt(function() {
      if ((this.re.match != null) && (this.re.contained != null)) {
        return "Expected " + (this.formatValue(utils.descOfNode(this.actual))) + " not to match " + (this.formatValue(this.re));
      } else {
        return this.message = "Expected " + (this.formatValue(this.actual)) + " not to match " + (this.formatValue(this.re));
      }
    });
  });
  ...
  spectacular.matcher('contains', function() {
    ...
    description(function() {
      ...
      if ((((_ref = this.value) != null ? _ref.match : void 0) != null) && (((_ref1 = this.value) != null ? _ref1.contained : void 0) != null)) {
        return "contains " + (this.formatValue(this.value));
      } else {
        valuesDescription = utils.literalEnumeration(this.values.map(function(v) {
          return utils.inspect(v);
        }));
        return "contains " + (this.formatValue(valuesDescription));
      }
    });
    match(function(actual) {
      var _ref, _ref1;
    ...
    failureMessageForShould(function() {
      var valuesDescription, _ref, _ref1;
      if ((((_ref = this.value) != null ? _ref.match : void 0) != null) && (((_ref1 = this.value) != null ? _ref1.contained : void 0) != null)) {
        return "Expected " + (this.formatValue(utils.descOfNode(this.actual))) + " to contains " + (this.formatValue(this.value));
      } else {
        valuesDescription = utils.literalEnumeration(this.values.map(function(v) {
          return utils.inspect(v);
        }));
        return "Expected " + (this.formatValue(utils.descOfNode(this.actual))) + " to contains " + (this.formatValue(valuesDescription));
      }
    });
    return failureMessageForShouldnt(function() {
      var valuesDescription, _ref, _ref1;
      if ((((_ref = this.value) != null ? _ref.match : void 0) != null) && (((_ref1 = this.value) != null ? _ref1.contained : void 0) != null)) {
        return "Expected " + (this.formatValue(utils.descOfNode(this.actual))) + " not to contains " + (this.formatValue(this.value));
      } else {
        valuesDescription = utils.literalEnumeration(this.values.map(function(v) {
          return utils.inspect(v);
        }));
        return "Expected " + (this.formatValue(utils.descOfNode(this.actual))) + " not to contains " + (this.formatValue(valuesDescription));
      }
    });
  });
  ...
  spectacular.matcher('throwAnError', function() {
    ...
    description(function() {
      var msg;
      msg = this.message != null ? " with message " + (this.formatValue(this.message)) : '';
      if (this["arguments"] != null) {
        msg += " with arguments " + (this.formatValue(utils.inspect(this["arguments"])));
      }
      if (this.context != null) {
        msg += " in context " + (this.formatValue(utils.inspect(this.context)));
      }
    ...
    failureMessageForShould(function() {
      return "Expected to " + this.description + " but was " + (this.formatValue(this.error));
    });
    return failureMessageForShouldnt(function() {
      return "Expected not to " + this.description + " but was " + (this.formatValue(this.error));
    });
  });

  spectacular.matcher('haveAttribute', function() {
    takes('attribute');
    chain('to', function(matcher) {
      this.matcher = matcher;
    });
    description(function() {
      var desc;
      desc = "have attribute " + (this.formatValue(this.attribute));
      if (this.matcher != null) {
        desc += ' to ' + this.matcher.description;
      }
      return desc;
    ...
    match(function(actual) {
      if (this.matcher != null) {
        return actual.hasAttribute(this.attribute) && this.matcher.match(actual.getAttribute(this.attribute));
      } else {
        return actual.hasAttribute(this.attribute);
      }
    });
    failureMessageForShould(function() {
      var desc;
      desc = "Expected " + (this.formatValue(utils.descOfNode(this.actual))) + " to have an attribute " + (this.formatValue(this.attribute));
      if (this.matcher != null) {
        desc += ' to ' + this.matcher.description;
      }
      return desc;
    ...
    return failureMessageForShouldnt(function() {
      var desc;
      desc = "Expected " + (this.formatValue(utils.descOfNode(this.actual))) + " not to have an attribute " + (this.formatValue(this.attribute));
      if (this.matcher != null) {
        desc += ' to ' + this.matcher.description;
      }
      return desc;
  ...
  spectacular.matcher('haveAttributes', function() {
    var collectHashs, collectStrings;
    collectStrings = function(col) {
      return col.filter(function(el) {
        return typeof el === 'string';
    ...
    takes('attributes...');
    description(function() {
      var desc, descs, hashAttributes, stringAttributes,
        _this = this;
      stringAttributes = collectStrings(this.attributes).map(function(v) {
        return _this.formatValue(v);
      });
      hashAttributes = collectHashs(this.attributes);
      descs = [];
      descs = descs.concat(stringAttributes);
      hashAttributes.forEach(function(item) {
        var _results;
        _results = [];
        for (k in item) {
          v = item[k];
      ...
      desc = "have " + (descs.length > 1 ? 'attributes' : 'attribute') + " ";
      desc += utils.literalEnumeration(descs);
      return desc;
    });
    match(function(actual) {
      ...
      this.attributes.forEach(function(key) {
        ...
        if (typeof key === 'object') {
          _results = [];
          for (k in key) {
            _results.push(_this.matchers.push(haveAttribute(k).to(key[k])));
          }
          return _results;
        } else {
          return _this.matchers.push(haveAttribute(key));
        }
      });
      res = true;
      _ref = this.matchers;
  ...
  spectacular.matcher('haveClass', function() {
    takes('className');
    description(function() {
      return "have class " + (this.formatValue(this.className));
    });
    match(function(actual) {
      var classes, _ref;
      classes = actual.getAttribute('class');
      return (classes != null) && (_ref = this.className, __indexOf.call(classes.split(/\s+/g), _ref) >= 0);
    });
    failureMessageForShould(function() {
      return "Expected " + (this.formatValue(utils.descOfNode(this.actual))) + " to " + this.description;
    });
    return failureMessageForShouldnt(function() {
      return "Expected " + (this.formatValue(utils.descOfNode(this.actual))) + " not to " + this.description;
    });
  });
  ...
  spectacular.matcher('haveSelector', function() {
    takes('selector');
    description(function() {
      return "have content that match " + (this.formatValue(this.selector));
    });
    match(function(actual) {
      var _this = this;
      if (actual.length != null) {
    ...
    failureMessageForShould(function() {
      return "Expected " + (this.formatValue(utils.descOfNode(this.actual))) + " to have selector " + (this.formatValue(this.selector));
    });
    return failureMessageForShouldnt(function() {
      return "Expected " + (this.formatValue(utils.descOfNode(this.actual))) + " not to have selector " + (this.formatValue(this.selector));
    });
  });
  ...
  spectacular.formatters.console.DocumentationFormatter = (function() {
    function DocumentationFormatter(example, options) {
      this.example = example;
      this.options = options;
    }

    DocumentationFormatter.prototype.format = function() {
      var ancestors, dif, res, start, state, _base, _base1;
      state = this.example.result.state;
      (_base = this.options).lastDepth || (_base.lastDepth = 0);
      (_base1 = this.options).lastAncestorsStack || (_base1.lastAncestorsStack = []);
      ancestors = this.example.ancestors.filter(function(e) {
        return e.ownDescription !== '';
      });
      dif = this.cropAncestors(ancestors, this.options.lastAncestorsStack);
      start = ancestors.length - dif.length;
      res = this.formatDocumentation(this.example, dif, start, COLOR_MAP[state]);
      this.options.lastAncestorsStack = ancestors;
      return res;
    };

    DocumentationFormatter.prototype.formatDocumentation = function(example, stack, start, color) {
      ...
      res += '\n';
      res += utils.indent(spectacular.utils.colorize(utils.strip(example.ownDescriptionWithExpectations), color, this.options.colors), (start + 1) * 2);
      this.options.lastDepth = start;
      return res;
    };

    DocumentationFormatter.prototype.cropAncestors = function(ancestors, lastAncestorsStack) {
      var a, elder, _i, _len;
      a = [];
    ...
    return DocumentationFormatter;

  })();

  spectacular.formatters.console.DurationFormatter = (function() {
    function DurationFormatter(runner, results) {
      this.runner = runner;
      this.results = results;
      this.options = this.runner.options;
    }

    DurationFormatter.prototype.format = function() {
      var loadDuration, loadEndedAt, loadStartedAt, promise, res, specsDuration, specsEndedAt, specsStartedAt, _ref1;
      promise = new spectacular.Promise;
      _ref1 = this.results, loadStartedAt = _ref1.loadStartedAt, loadEndedAt = _ref1.loadEndedAt, specsStartedAt = _ref1.specsStartedAt, specsEndedAt = _ref1.specsEndedAt;
    ...
    DurationFormatter.prototype.formatDuration = function(start, end) {
      var duration;
      duration = (end.getTime() - start.getTime()) / 1000;
      return spectacular.utils.colorize("" + (Math.max(0, duration)) + "s", 'yellow', this.options.colors);
    };
  ...
  spectacular.formatters.console.ErrorFormatter = (function() {
    function ErrorFormatter(error, options) {
      this.error = error;
      this.options = options;
    }

    ErrorFormatter.prototype.format = function() {
      var column, file, fileFormatter, formatters, line, promise, res, stackFormatter, _ref1,
        _this = this;
      promise = new spectacular.Promise;
      formatters = spectacular.formatters.console;
      res = this.formatMessage(this.error.message);
      res += '\n';
      if (this.error.stack != null) {
        stackFormatter = new formatters.ErrorStackFormatter(this.error.stack, this.options);
        if (this.options.showSource) {
          _ref1 = stackFormatter.parser.details(stackFormatter.parser.lines[0]), file = _ref1.file, line = _ref1.line, column = _ref1.column;
          fileFormatter = new formatters.ErrorSourceFormatter(this.options, file, line, column);
          fileFormatter.format().then(function(result) {
            res += spectacular.utils.colorize(result, 'grey', _this.options.colors);
            return stackFormatter.format();
    ...
    ErrorFormatter.prototype.formatMessage = function(message) {
      return "\n" + (spectacular.utils.indent(message || ''));
    };
  ...
  spectacular.formatters.console.ErrorSourceFormatter = (function() {
    function ErrorSourceFormatter(options, file, line, column) {
      this.options = options;
      this.file = file;
      if (column == null) {
        column = 1;
    ...
    ErrorSourceFormatter.prototype.format = function() {
      var promise,
        _this = this;
      promise = new spectacular.Promise;
      if (this.options.hasSourceMap(this.file)) {
        this.options.getOriginalSourceFor(this.file, this.line, this.column).then(function(res) {
          return promise.resolve(_this._format(res));
        });
      } else {
        this.options.loadFile(this.file).then(function(content) {
          return promise.resolve(_this._format({
            content: content,
            line: _this.line,
            column: _this.column
          }));
    ...
    ErrorSourceFormatter.prototype._format = function(_arg) {
      var column, columnIndicator, content, end, line, lines, start, _ref1;
      content = _arg.content, line = _arg.line, column = _arg.column;
      _ref1 = this.selectLines(content, line), lines = _ref1.lines, start = _ref1.start, end = _ref1.end;
      columnIndicator = this.columnIndicator(column);
      if (line !== end) {
    ...
    ErrorSourceFormatter.prototype.selectLines = function(content, line) {
      var endLine, lines, startLine;
      lines = content.split('\n');
      startLine = Math.max(1, line - 3) - 1;
      endLine = Math.min(lines.length, line + 1) - 1;
      lines = lines.slice(startLine, +endLine + 1 || 9e9).map(function(l, i) {
        var pad;
        pad = l.length > 0 ? ' ' : '';
        return "    " + (utils.padRight(i + startLine + 1)) + " |" + pad + l;
      });
      return {
        lines: lines,
        start: startLine + 1,
    ...
    ErrorSourceFormatter.prototype.columnIndicator = function(column) {
      return "         | " + (spectacular.utils.padRight('^', column));
    };

    return ErrorSourceFormatter;

  })();

  spectacular.formatters.console.ErrorStackFormatter = (function() {
    function ErrorStackFormatter(stack, options) {
      this.stack = stack;
      this.options = options;
      this.parser = new spectacular.errors.ErrorParser(this.stack);
    }

    ErrorStackFormatter.prototype.format = function() {
      var l, lines, promise, stack;
      promise = new spectacular.Promise;
      lines = this.parser.lines;
      ...
      stack = "\n" + (lines.join('\n')) + "\n\n";
      promise.resolve(spectacular.utils.colorize(stack, 'grey', this.options.colors));
      return promise;
    };

    return ErrorStackFormatter;

  })();

  spectacular.formatters.console.ExampleResultsFormatter = (function() {
    function ExampleResultsFormatter(example, options, id) {
      this.example = example;
      this.options = options;
      this.id = id;
    }

    ExampleResultsFormatter.prototype.format = function() {
      var expectation, promise, promises, reason, result, _i, _len, _ref1;
      result = this.example.result;
      promise = new spectacular.Promise;
      switch (result.state) {
        case 'errored':
          this.formatExample(this.example.fullDescription, this.example.reason, result.state).then(function(msg) {
          ...
          if (result.expectations.length > 0) {
            ...
            for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
              ...
              if (!expectation.success) {
                ...
                promises.push(this.formatExample(expectation.fullDescription, reason, result.state));
              }
            }
            spectacular.Promise.all(promises).then(function(results) {
    ...
    ExampleResultsFormatter.prototype.formatExample = function(message, error, state) {
      var errorFormatter,
        _this = this;
      errorFormatter = new spectacular.formatters.console.ErrorFormatter(error, this.options);
      return errorFormatter.format().then(function(errorTxt) {
        var res;
        res = _this.badge(message, BADGE_MAP[state], COLOR_MAP[state]);
        return res + '\n' + errorTxt;
      });
    };

    ExampleResultsFormatter.prototype.badge = function(message, label, color) {
      var c, hc, res;
      c = spectacular.utils.colorize;
      hc = this.options.colors;
      res = '';
  ...
  spectacular.formatters.console.ProfileFormatter = (function() {
    function ProfileFormatter(runner, results) {
      var _ref1;
      this.runner = runner;
      this.results = results;
      _ref1 = this.runner, this.examples = _ref1.examples, this.options = _ref1.options;
    }

    ProfileFormatter.prototype.format = function() {
      var duration, example, promise, rate, res, sortedExamples, topSlowest, totalDuration, _i, _len;
      promise = new spectacular.Promise;
      sortedExamples = this.examples.sort(function(a, b) {
        return b.duration - a.duration;
      }).slice(0, 10);
      totalDuration = this.results.specsEndedAt.getTime() - this.results.specsStartedAt.getTime();
      ...
      for (_i = 0, _len = sortedExamples.length; _i < _len; _i++) {
        ...
        res += "    " + (spectacular.utils.colorize(duration, 'red', this.options.colors)) + " " + example.fullDescription + "\n";
      }
      promise.resolve("" + res + "\n");
      return promise;
    };
  ...
  spectacular.formatters.console.ProgressFormatter = (function() {
    function ProgressFormatter(example, options) {
      this.example = example;
      this.options = options;
    }

    ProgressFormatter.prototype.format = function() {
      var state;
      state = this.example.result.state;
      return spectacular.utils.colorize(CHAR_MAP[state], COLOR_MAP[state], this.options.colors);
    };
  ...
  spectacular.formatters.console.ResultsFormatter = (function() {
    function ResultsFormatter(runner, results) {
      var _ref1;
      this.runner = runner;
      this.results = results;
      this.options = this.runner.options;
      _ref1 = this.results, this.errors = _ref1.errors, this.failures = _ref1.failures, this.skipped = _ref1.skipped, this.pending = _ref1.pending, this.results = _ref1.results;
    }

    ResultsFormatter.prototype.format = function() {
      var assertions, errored, failures, pending, promise, skipped, success;
      promise = new spectacular.Promise;
      failures = this.failures.length;
      errored = this.errors.length;
      skipped = this.skipped.length;
      pending = this.pending.length;
      success = this.runner.examples.length - failures - errored - pending - skipped;
      assertions = this.results.reduce((function(a, b) {
        return a + b.expectations.length;
      }), 0);
      promise.resolve(this.formatResults(success, failures, errored, skipped, pending, assertions));
      return promise;
    };

    ResultsFormatter.prototype.formatResults = function(success, failures, errors, skipped, pending, assertions) {
      var hasError, res, toggle;
      toggle = spectacular.utils.toggle;
      hasError = failures + errors;
      res = [];
      res.push(this.formatCount(success, 'success', 'success', toggle(hasError, 'green')));
      res.push(this.formatCount(assertions, 'assertion', 'assertions', toggle(hasError, 'green')));
      res.push(this.formatCount(failures, 'failure', 'failures', toggle(hasError, 'green', 'red')));
      res.push(this.formatCount(errors, 'error', 'errors', toggle(errors, 'green', 'yellow')));
      res.push(this.formatCount(skipped, 'skipped', 'skipped', toggle(skipped, 'green', 'magenta')));
      res.push(this.formatCount(pending, 'pending', 'pending', toggle(pending, 'green', 'yellow')));
      return "  " + (res.join(', ')) + "\n";
    };
    ...
    ResultsFormatter.prototype.formatCount = function(value, singular, plural, color) {
      ...
      if (color != null) {
        s = spectacular.utils.colorize(s, color, this.options.colors);
      }
      return s;
    };
  ...
  spectacular.formatters.console.ResumeFormatter = (function() {
    function ResumeFormatter(runner, results) {
      var _ref1;
      this.runner = runner;
      this.results = results;
      this.options = this.runner.options;
      _ref1 = this.results, this.errors = _ref1.errors, this.failures = _ref1.failures, this.skipped = _ref1.skipped, this.pending = _ref1.pending;
    }

    ResumeFormatter.prototype.format = function() {
      var promise, res;
      promise = new spectacular.Promise;
      res = '';
      if (this.errors.length > 0) {
        res += this.formatResume('Errors:', this.errors, 'yellow');
      }
      if (this.failures.length > 0) {
        res += this.formatResume('Failures:', this.failures, 'red');
      }
      if (this.skipped.length > 0) {
        res += this.formatResume('Skipped:', this.skipped, 'magenta');
      }
      if (this.pending.length > 0) {
        res += this.formatResume('Pending:', this.pending, 'yellow');
      }
      promise.resolve(res);
      return promise;
    };

    ResumeFormatter.prototype.formatResume = function(desc, array, color) {
      var res;
      res = "    " + desc + "\n\n";
  ...
  spectacular.formatters.console.SeedFormatter = (function() {
    function SeedFormatter(runner) {
      this.runner = runner;
      this.options = this.runner.options;
      this.seed = this.options.seed;
    }

    SeedFormatter.prototype.format = function() {
      var promise;
      promise = new spectacular.Promise;
      promise.resolve("  Seed " + (spectacular.utils.colorize(this.seed.toString(), 'cyan', this.options.colors)) + "\n\n");
      return promise;
    };

    return SeedFormatter;
  ...
  _ref1 = spectacular.formatters, CHAR_MAP = _ref1.CHAR_MAP, COLOR_MAP = _ref1.COLOR_MAP, BADGE_MAP = _ref1.BADGE_MAP;
  ...
  tag = function(tag, inner, attrs, block) {
    ...
    if (typeof inner === 'object') {
      _ref2 = ['', inner, attrs], inner = _ref2[0], attrs = _ref2[1], block = _ref2[2];
    }
    if (typeof inner === 'function') {
      _ref3 = ['', {}, inner], inner = _ref3[0], attrs = _ref3[1], block = _ref3[2];
    }
  ...
  spectacular.widgets.ExampleViewer = (function() {
    ...
    ExampleViewer.prototype.displayStack = function(stack) {
      ...
      return parser.lines.forEach(function(stackLine, i) {
        var column, div, file, line, method, _ref2;
        _ref2 = parser.details(stackLine), file = _ref2.file, line = _ref2.line, column = _ref2.column, method = _ref2.method;
  ...
  spectacular.widgets.ExamplesList = (function() {
    ...
    ExamplesList.prototype.onResult = function(event) {
      ...
      if ((state === 'failure' || state === 'errored') && !hasClass(this.reporter.container, 'hide-success')) {
        ...
        addClass(this.reporter.container, 'hide-success');
        this.reporter.snapper.open('right');
        if ((_ref2 = this.viewer) != null) {
          _ref2.displayCard(example);
        }
      }
  ...
  spectacular.widgets.ExamplesSearch = (function() {
    ...
    ExamplesSearch.prototype.init = function(runner, reporter) {
      ...
      if ((_ref2 = this.reporter.container.querySelector('#examples header')) != null) {
        _ref2.appendChild(this.container);
      }
  ...
  spectacular.widgets.RunnerProgress = (function() {
    ...
    RunnerProgress.prototype.onResult = function(e) {
      ...
      if ((_ref2 = example.result.state) === 'failure' || _ref2 === 'errored') {
        addClass(this.container, 'fail');
      }
      return this.update();
    };
  ...
  spectacular.ConsoleReporter = (function() {
    ...
    ConsoleReporter.getDefault = function(options) {
      var f, reporter;
      reporter = new ConsoleReporter(options);
      f = spectacular.formatters.console;
      if (options.resume) {
        reporter.resultFormatters.push(f.ResumeFormatter);
      }
      if (options.profile) {
        reporter.resultFormatters.push(f.ProfileFormatter);
      }
    ...
    function ConsoleReporter(options) {
      ...
      this.exampleResultsFormatters = [];
      this.progressFormatters = {};
    }
    ...
    ConsoleReporter.prototype.onResult = function(event) {
      var example;
      example = event.target;
      return this.printExampleResult(example);
    };

    ConsoleReporter.prototype.onEnd = function(event) {
      var allResults, errors, failures, options, printResult, promise, runner, runnerResults,
        _this = this;
      runnerResults = event.target;
      runner = runnerResults.runner;
      options = this.options;
      printResult = function(example, i) {
        var promise, res;
        res = '';
        promise = spectacular.Promise.unit('');
        _this.exampleResultsFormatters.forEach(function(formatter) {
          return promise = promise.then(function(result) {
            res += result;
            return new formatter(example, options, i + 1).format();
          });
        });
      ...
      if (errors.length > 0) {
        promise = promise.then(function() {
          return spectacular.Promise.all(errors);
        });
      }
      if (failures.length > 0) {
        promise = promise.then(function(results) {
          allResults = allResults.concat(results);
          return spectacular.Promise.all(failures);
        });
      }
      if (this.resultFormatters.length > 0) {
        promise = promise.then(function(results) {
          allResults = allResults.concat(results);
          return spectacular.Promise.all(_this.resultFormatters.map(function(formatter) {
            return new formatter(runner, runnerResults).format();
          }));
        });
      }
      return promise.then(function(results) {
        allResults = allResults.concat(results);
        return _this.dispatch(new spectacular.Event('report', allResults.join('') + '\n\n'));
      }).fail(function(reason) {
    ...
    ConsoleReporter.prototype.printExampleResult = function(example) {
      var res, state;
      state = example.result.state;
      res = new this.progressFormatters[this.options.format](example, this.options).format();
      if (res != null) {
  ...
  spectacular.BrowserReporter = (function() {
    ...
    BrowserReporter.prototype.initSnapper = function() {
      ...
      return document.body.onresize = function() {
        _this.snapper.close();
        _this.snapper.settings({
          minPosition: -viewerSize()
        });
        return _this.container.querySelector('#viewer').setAttribute('style', "width: " + (viewerSize()) + "px;");
      };
    };
    ...
    if (options.getOriginalSourceFor == null) {
      options.getOriginalSourceFor = function(file, line, column) {
        ...
        this.loadFile(this.getSourceURLFor(file)).then(function(source) {
          ...
          _ref2 = consumer.originalPositionFor({
            line: line,
            column: column
          }), line = _ref2.line, column = _ref2.column;
  ...
  window.onload = function() {
    var filter, n, reporter, s, scripts, _i, _len, _ref2;
    ...
    if (spectacular.options.verbose) {
      ...
      for (_i = 0, _len = scripts.length; _i < _len; _i++) {
        s = scripts[_i];
        console.log("    " + ((_ref2 = s.attributes.getNamedItem("src")) != null ? _ref2.value : void 0));
      }
      console.log('');
    }
