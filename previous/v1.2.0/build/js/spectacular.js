...
(function() {
  var FILE_RE, PROGRESS_CHAR_MAP, PROGRESS_COLOR_MAP, addClass, ancestors, cache, currentWindowOnload, defaults, exports, fixNodeHeight, hasClass, isCommonJS, k, loaders, removeClass, spectacular, toggleClass, utils, v, wrapNode,
    __slice = [].slice,
  ...
  spectacular.BrowserStackReporter = (function(_super) {
    ...
    BrowserStackReporter.prototype.loadSource = function(stackLine) {
      ...
      return this.getLines(url, parseInt(line), parseInt(column));
    };
