...
(function() {
  var PROGRESS_CHAR_MAP, PROGRESS_COLOR_MAP, addClass, cache, currentWindowOnload, defaults, exports, fixNodeHeight, hasClass, isCommonJS, k, loaders, removeClass, spectacular, toggleClass, utils, v, wrapNode,
    __slice = [].slice,
  ...
  spectacular.nextTick = (typeof process !== "undefined" && process !== null ? process.setImmediate : void 0) || (typeof process !== "undefined" && process !== null ? process.nextTick : void 0) || function(callback) {
  ...
  spectacular.factories.Factory = (function(_super) {
    ...
    Factory.prototype.build = function(traits, options) {
      var args, instance, trait, _i, _len;
      if (options == null) {
        options = {};
      }
      args = this.getConstructorArguments(traits);
      instance = this.parent != null ? this.parent.instanciate(args) : this.instanciate(args);
    ...
    Factory.prototype.instanciate = function(args) {
      return build(this["class"], args);
    };

    Factory.prototype.getConstructorArguments = function(traits) {
      var args, trait, traitArgs, _i, _len;
      args = this.getFactoryConstructorArguments();
      for (_i = 0, _len = traits.length; _i < _len; _i++) {
        trait = traits[_i];
        traitArgs = this.findTrait(trait)["arguments"];
        if (traitArgs != null) {
          args = traitArgs;
        }
      }
    ...
    Factory.prototype.getFactoryConstructorArguments = function() {
      var _ref;
      return this["arguments"] || ((_ref = this.parent) != null ? _ref.getFactoryConstructorArguments() : void 0);
    };
